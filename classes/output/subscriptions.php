...
namespace bbbext_bnemail\output;
            ...
            foreach ($modules as $module) {
                if ($module->modname == 'bigbluebuttonbn') {
                    ...
                    $toggle = [
                        ...
                        'label' => $issubscribed ? get_string('subscribed', 'bbbext_bnemail') :
                            get_string('unsubscribed', 'bbbext_bnemail'),
                        'checked' => $issubscribed,
                        'url' => new \moodle_url('/mod/bigbluebuttonbn/extension/bnemail/managesubscriptions.php'),
                        'cmid' => $module->id,
                        'name' => 'state',
                        'value' => !$issubscribed,
                        'disabled' => false,
